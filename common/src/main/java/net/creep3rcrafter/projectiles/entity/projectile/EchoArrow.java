...
public class EchoArrow extends AbstractArrow {
    public static final ItemStack ARROW_ITEMSTACK = new ItemStack(ModItems.ECHO_ARROW.get());
    ...
    public EchoArrow(Level level, double x, double y, double z, ItemStack itemStack) {
        super(ModEntityTypes.ECHO_ARROW.get(), x, y, z, level, itemStack);
    }

    public EchoArrow(Level level, LivingEntity livingEntity, ItemStack itemStack) {
        super(ModEntityTypes.ECHO_ARROW.get(), livingEntity, level, itemStack);
    }
